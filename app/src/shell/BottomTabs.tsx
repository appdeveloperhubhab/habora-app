...
/**
 * Нижняя навигация из двух разделов: «Привычки» — где вы делаете, «Друзья» —
 * где смотрите, как идут дела у тех, с кем есть общие привычки.
 *
...
const TABS: { id: Tab; icon: 'habits' | 'friends' }[] = [
  { id: 'habits', icon: 'habits' },
  { id: 'friends', icon: 'friends' },
]
