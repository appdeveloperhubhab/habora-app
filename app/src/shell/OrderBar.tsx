 ...
 *
 * Порядок слева направо — от ближнего взгляда к дальнему: неделя строкой,
 * месяц плиткой по две в ряд, год целиком. Так переключатель читается как
 * шкала глубины, а не как набор из трёх разных внешностей.
 */
