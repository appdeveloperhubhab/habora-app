...
const PATHS: Record<IconName, ReactNode> = {
  ...
  /* Кубок: чаша с двумя ручками, ножка и подставка. Для рекорда серии —
     флажок огня уже занят текущей, и две одинаковые иконки рядом
     заставляли бы вчитываться в подписи вместо того, чтобы узнавать. */
  trophy: (
    <>
      <path d="M7.5 4h9v4.5a4.5 4.5 0 0 1-9 0V4z" />
      <path d="M7.5 5.5H5v1a3 3 0 0 0 2.8 3" />
      <path d="M16.5 5.5H19v1a3 3 0 0 1-2.8 3" />
      <path d="M12 13v3.5" />
      <path d="M8.5 20h7" />
    </>
  ),
