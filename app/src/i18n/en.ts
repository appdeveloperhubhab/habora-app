...
export const en: Dict = {
  ...
  editor: {
    ...
    pickEmoji: 'Your emoji',
    emojiHint: 'Tap and pick any emoji from your keyboard',
    iconsHint: 'Or choose one from the set',
    nameRequired: 'Enter a name',
  ...
  settings: {
    ...
    bgAccent: 'Accent glow',
    bgAccentHint: 'Soft accent light from the top',
    bgGradient: 'Gradient',
    bgGradientHint: 'From two chosen colours',
    bgPhoto: 'Your photo',
    bgPhotoHint: 'Upload any image',
    gradientFrom: 'From',
    gradientTo: 'To',
